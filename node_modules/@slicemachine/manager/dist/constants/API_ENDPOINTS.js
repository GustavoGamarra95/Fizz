import { addTrailingSlash, removeTrailingSlash } from "../lib/trailingSlash.js";
  ...
  switch (process.env.SM_ENV) {
    case APPLICATION_MODE.Development: {
      ...
      if (missingAPIEndpoints.length > 0) {
        console.error(`You are running Slice Machine in development mode (SM_ENV=${APPLICATION_MODE.Development}) where API endpoints are configured via environment variables.
