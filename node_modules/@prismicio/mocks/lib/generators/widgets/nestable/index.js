...
const Repeatable_1 = require("./Repeatable");
...
(0, tslib_1.__exportStar)(require("./Repeatable"), exports);
...
exports.NestableWidgetMock = {
    generate(def, config) {
        ...
        switch (def.type) {
            ...
            case "Link":
                if ((_a = def.config) === null || _a === void 0 ? void 0 : _a.repeat) {
                    return Repeatable_1.RepeatableMock.generate(def, (config === null || config === void 0 ? void 0 : config.type) === "Repeatable" ? config : undefined);
                }
    ...
    patch(diff, content, config) {
        ...
        const patched = Color_1.ColorMock.applyPatch(data) ||
            ...
            Repeatable_1.RepeatableMock.applyPatch(data);
